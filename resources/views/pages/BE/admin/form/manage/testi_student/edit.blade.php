...
@section('content')
    ...
    <section class="testi_student-archive">
        <form action="{{ url('/manage/testi_student/' . $id) }}" method="post" id="form" autocomplete="false"
                    ...
                    <div class="col-lg-12 login-form-wrap">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name"
                                value="{{ $testi_student->name }}" id="title" autocomplete="false" required>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pekerjaan"
                                value="{{ $testi_student->pekerjaan }}" id="pekerjaan" autocomplete="false" required>
                            @error('pekerjaan')
                                <div class="text-danger" style="display: block;">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="detail" id="detail" class="form-control" required>{{ $testi_student->detail }}</textarea>
                            @error('detail')
                                <div class="text-danger" style="display: block;">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" placeholder="Harga Kelas" class="form-control-file" name="image"
                                ...
                                data-default-file="{{ asset('/assets/images/testi_students/' . $testi_student->image) }}">
                            @error('image')
                                <div class="text-danger" style="display: block;">
                                    {{ $message }}
                                </div>
