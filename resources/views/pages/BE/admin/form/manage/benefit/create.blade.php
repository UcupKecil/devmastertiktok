...
@section('content')
    ...
    <section class="benefit-archive">
        <form action="{{ url('/manage/benefit') }}" method="post" id="form" autocomplete="false"
                ...
                <div class="row">
                    <div class="col-lg-12 login-form-wrap">
                        ...
                        <div class="form-group">
                            <label for="name">Judul Benefit</label>
                            <input type="text" placeholder="Judul Benefit" class="form-control" name="name"
