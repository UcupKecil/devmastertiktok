...
@section('content')
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="banner-content text-center">
                        ...
                        <p>
                            Manage
                            <span> > </span>
                            <a href="{{ url('/manage/benefit') }}">Benefit</a>
                            <span> > </span>
                            {{ $title }}
                        </p>
                    </div>
    ...
    <section class="benefit-archive">
        <form action="{{ url('/manage/benefit/' . $id) }}" method="post" id="form" autocomplete="false"
                    ...
                    <div class="col-lg-12 login-form-wrap">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name"
                                value="{{ $benefit->name }}" id="title" autocomplete="false" required>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="detail" id="detail" class="form-control" required>{{ $benefit->detail }}</textarea>
                            @error('detail')
                                <div class="text-danger" style="display: block;">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" placeholder="Harga Kelas" class="form-control-file" name="image"
                                ...
                                data-default-file="{{ asset('/assets/images/benefits/' . $benefit->image) }}">
                            @error('image')
                                <div class="text-danger" style="display: block;">
                                    {{ $message }}
                                </div>
